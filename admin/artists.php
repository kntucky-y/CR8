                ...
                <div class="overflow-x-auto">
                    <table id="artists-table" class="w-full text-left ">
                        <thead class="bg-gray-50">
                            <tr>
                                 <th class="sticky top-0 z-10 bg-white p-4 font-semibold text-gray-600">Artist Name</th>
        <th class="sticky top-0 z-10 bg-white p-4 font-semibold text-gray-600">Email Address</th>
        <th class="sticky top-0 z-10 bg-white p-4 font-semibold text-gray-600 text-center">Products Listed</th>
        <th class="sticky top-0 z-10 bg-white p-4 font-semibold text-gray-600">Date Joined</th>
        <th class="sticky top-0 z-10 bg-white p-4 font-semibold text-gray-600 text-center">Actions</th>  
     </tr>
                        </thead>
